...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			//$icon_html = '<em>'.wp_get_attachment_image(get_field('menu_image', $item),'full').'</em>';
			// Put the item contents into $output.
			$item_output .= isset( $args->link_before ) ? $args->link_before .'<span class="hexagon d-inline-block d-xl-none"></span>'. $title . $args->link_after : '';
			/*

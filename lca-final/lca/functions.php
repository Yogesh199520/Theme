...
function lca_register_post_type() {
    ...
    $singular = 'Latino Talent';
    $plural = 'Latino Talents';
    $labels = array(
        'name'                  => $plural,
        'singular_name'         => $singular,
        'add_name'              => 'Add New',
    ...
    register_post_type('latino-talent',$args);

    $singular = 'Adelante Workshop';
    $plural = 'Adelante Workshop';
    $labels = array(
        'name'                  => $plural,
        'singular_name'         => $singular,
        'add_name'              => 'Add New',
    ...
    register_post_type('adelante-workshop',$args);
...
function custom_get_availability( $availability, $_product ) {
  ...
  if ( $_product->is_in_stock() ) $availability['availability'] = __($stock . ' Seats', 'woocommerce');
  if ( !$_product->is_in_stock() ) $availability['availability'] = __('Seat not available', 'woocommerce');

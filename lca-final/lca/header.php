...
<head>
    ...
    <meta name="description" content="We are dedicated to supporting the career success of our Latino Community As a firm, we are committed to providing a  valid assessment, coaching and training solutions to Latinos be successful in their career">
...
<body <?php body_class(); ?>>
    ...
    $take_assessment = get_field('take_assessment','option');
    ?>
    <header id="header">
            ...
            <div class="container">
                <div class="nav-inside d-flex align-items-center justify-content-between">
                    ...
                    <div class="header-right">
                        <a href="<?php echo $take_assessment; ?>" target="_blank" class="btn btn-default header-btn">Take Assessment</a>
                    </div>
                </div>
            </div>
        </nav>

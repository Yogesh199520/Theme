    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            	...
            	?>
                <ul class="lca-info-list  os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.35s">
                	<?php 
...
<div class="content-container pt-0">
    <div class="container">
        ...
        <div class="row d-md-flex align-items-md-center">
        	<?php 
        	if(!empty($bio_image)): echo '<div class="col-md-4"><div class="large-thumbnails os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.3s">'.$bio_image.'</div></div>'; endif; 
        	if(!empty($bio_body_text)): echo '<div class="col-md-8  os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.35s">'.$bio_body_text.'</div>'; endif;
        	?>
        </div>
    </div>
</div>

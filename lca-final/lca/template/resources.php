...
if(have_rows('resource_intro_button_link')):
	while(have_rows('resource_intro_button_link')): the_row();
...
<div class="content-container">
    <div class="container">
        ...
        <div class="row">
        	<?php 
        	if(!empty($resource_intro_body_text)): echo '<div class="col-md-7 os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.3s">'.$resource_intro_body_text.'</div>'; endif;
        	if(!empty($resource_intro_bg_image)):
        	?>
            <div class="col-md-5">
                <div class="resource-bg os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.35s">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="dot-list hash-underline os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.35s">
                	<?php 

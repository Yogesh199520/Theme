            ...
            <div class="col-md-12">
                <div class="hero-content-box d-lg-flex flex-lg-wrap">
                    ...
                    <div class="hcb-left">
                        <div class="hcb-box h-100 d-flex flex-wrap">
                            <div class="hero-text-slider hero-slider d-flex align-items-center">
                                ...
                                $animation_duration = ['0.3s', '0.35s', '0.40s', '0.45s', '0.50s', '0.55', '0.60s'];
                                $index = get_row_index() - 1;
                                ?>
                                <div class="ht-item">
                                    <div class="ht-box">
                                        <div class="ht-upper">
                                            <div class="ht-text os-animation" data-os-animation="fadeIn" data-os-animation-delay="<?php echo $animation_duration[$index]; ?>">
                                                <?php 
                                        ...
                                        <div class="ht-lower os-animation" data-os-animation="fadeIn" data-os-animation-delay="<?php echo $animation_duration[$index]; ?>">
                                            <?php 
                            ...
                            <div class="add-custom-arrow os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.45s">
                                <ul>
                                    <li class="prev"></li>
                                    <li class="next"></li>
                                </ul>
                            ...
                            <div class="hero-image-slider os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.4s">
                                <div class="hi-item">
                                    <div class="hi-img">
                    ...
                    <div class="hcb-right">
                        ...
                        $button_text = get_sub_field('button_text');
                        $button_link = get_sub_field('button_link');
                        $animation_duration = ['0.5s', '0.55s', '0.6s', '0.65s', '0.7s', '0.75', '0.8s'];
                        $index = get_row_index() - 1;
                        ?>
                        <div class="card-block-box <?php echo $bg_color; ?>-bg position-relative text-center">
                            ...
                            <div class="bard-block-text os-animation" data-os-animation="fadeInUp" data-os-animation-delay="<?php echo $animation_duration[$index]; ?>">
                                <?php 
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            	...
            	?>
                <ul class="post-list d-flex flex-wrap  os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.35s">
                	<?php 

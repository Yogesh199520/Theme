...
<?php if(!empty($phone)):?>
<a href="tel:<?php echo $tel; ?>" class="fixed-widget-box">
    <p>For more information call <span><?php echo $phone; ?> <img src="<?php echo IMG.'dark-arrow.png'; ?>" alt="dark-arrow" /></span></p>
</a>
<?php endif; ?>
<footer id="footer" class="text-uppercase">
    ...
    <div class="footer-upper">
        <div class="container">
            <div class="row">
                <?php if(!empty($heading)): echo '<div class="col-md-4"><div class="hu-label">'.$heading.'</div></div>'; endif; ?>
...
<?php /*echo do_shortcode('[asp_product id="609"]');*/ ?>
<?php wp_footer(); ?>
</body>
</html>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <?php 
                    if(!empty($career_ass_body_text)): echo '<div class="col-md-7">'.$career_ass_body_text.'</div>'; endif; 
                    ...
                    <div class="col-md-5">
                        <div class="card-block-box green-bg position-relative overflow-hidden">
                            ...
                            <div class="bard-block-text">
                                ...
                                if(!empty($career_ass_button_text)): echo '<a href="'.$career_ass_button_link.'" class="btn yellow-btn add-line">'.$career_ass_button_text.'</a>'; endif; 
                                ?>
                            </div>
                        </div>
                    </div>
...
<div class="content-container text-block-container overflow-hidden pt-0">
    <div class="container">
        <div class="row">
            ...
            <?php if(!empty($career_content_image)): ?>
            <div class="col-md-4">
                <div class="text-img-box position-relative add-top-shape">

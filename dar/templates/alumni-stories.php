...
<!--============================== Content Start ==============================-->
<?php 
$terms = get_terms('stories_category', array('hide_empty'=>false, 'parent' => 0));
if(!empty($terms)):
?>
<!--============================== Content Start ==============================-->
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <ul class="new-post-list two-coulmn d-flex flex-wrap">
                    ...
                    $image = wp_get_attachment_image(get_field('stories_image',$term),'large'); 
                    ...
                    <li class="ns-item os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.3<?php echo $count; ?>s">
                        <div class="ns-box">
                            ...
                            <div class="ns-content-box">
                                ...
                                <?php if(!empty($description)): echo '<p>'.$description.'</p>'; endif; ?>
                                <a href="<?php echo get_category_link($term->term_id); ?>" class="btn-hover color-1">Know more</a>
                            </div>
                        </div>
                    </li>
                    <?php

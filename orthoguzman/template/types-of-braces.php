...
<div id="content">
	<?php 
	$brace_body_text = get_field('brace_body_text');
	if(!empty($brace_body_text)):
	?>
    <section class="invi-sec1 pb_0">
        <div class="container">
            <h2 style="display:none;">Heading</h2>
            <?php echo $brace_body_text; ?>
        </div>
    </section>
    <?php 
	endif;
	if(have_rows('types_of_braces')):
	?>
    <section class="community-sec1">
        <div class="container">
        	<?php 
            while(have_rows('types_of_braces')): the_row();

...
if($_POST['post_member']=='Save' || $_POST['post_member']=='Add_another_member'){ ;
...
//update_user_meta($user_id, 'step', 3);
    ...
    <div class="col-12">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="post_title" name="post_title" placeholder="First NAME" value="" required />
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label>Middle Name</label>
                    <input type="text" class="form-control" id="middle_name" name="middle_name" placeholder="Middle Name"value="" required/>
                </div>
            </div> 
            <div class="col-md-4">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>Last Name</label>
                    <input type="text" class="form-control" id="f_last_name" name="f_last_name" placeholder="Last Number"/>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <?php if($count > 0): ?>
            <div class="col-md-6">
                <input id="sumbit" class="btn-hover btn-save btn btn-outline btn-lg" type="submit" name="post_member" value="Add_another_member" />
            </div>
            <div class="col-md-6">
                <a href="javascript:void(0)" class="btn  btn-lg" id="next-step">Next</a>
            </div>
            <?php else: ?>
                <div class="col-md-12">
                    <input id="sumbit" class="btn-hover btn-save btn btn-outline btn-lg" type="submit" name="post_member" value="Save" />
                </div>
            <?php endif; ?>
        </div>
    </div>

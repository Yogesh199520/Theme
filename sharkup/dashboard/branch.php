...
<form id="registration" name="registration" method="post" action="<?php echo get_page_link('/') ?>" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="post_title" name="post_title" placeholder="COMPANY NAME(IN CASE OF BRANCH)" value="" required/>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label>COUNTRY OF REGISTRATION OF THE PARENT COMPANY</label>
                <input type="text" class="form-control" id="prcompany" name="prcompany" placeholder="COUNTRY OF REGISTRATION OF THE PARENT COMPANY" value="" required/>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="parent_company" name="parent_company" placeholder="ADDRESS OF THE PARENT COMPANY" value="" required/>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="en_option_one" name="en_option_one" placeholder="Option 1" value="" required/>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label>Option 1</label>
                <input type="text" class="form-control" id="ar_option_one" name="ar_option_one" placeholder="Option 1" value="" required/>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control" id="licence_type" name="licence_type" required>
                    <option value="">---</option>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control" id="visa_package" name="visa_package" required>
                    <option value="">---</option>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label>Option 1</label>
                <input type="text" class="form-control" id="activities_option_one" name="activities_option_one" placeholder="Option 1" required/>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-12">
            <input id="sumbit" class="btn-hover btn-save btn btn-outline btn-lg" type="submit" name="post_branch" value="Branch" />
        </div>
    </div>

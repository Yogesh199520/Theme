...
if($_POST['post_submit']=='Update'){
    ...
    <!-- <script>
        setTimeout(function(){
            window.location.href = "https://sharkup.ghoomophiro.com/pricing/";
        },2000);
    </script> -->
    <?php
}
?>
<form id="company-info" name="registration" method="post" action="<?php echo get_page_link('/') ?>" enctype="multipart/form-data">
    <!-- <div class="row">
        <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <div class="d-md-flex pl-0">
                    <div class="rdio rdio-primary radio-inline mr-4">
                        <input name="franchisee_data" class="franchisee" value="yes" id="radio_1" type="radio" <?php if($franchisee_data == 'yes'): echo 'checked'; endif; ?> />
                        <label for="radio_1">Yes </label>
                    </div>
                    <div class="rdio rdio-primary radio-inline mr-4">
                        <input name="franchisee_data" class="franchisee" value="no" id="radio_2" type="radio" <?php if($franchisee_data == 'no'): echo 'checked'; endif; ?>/>
                        <label for="radio_2">No</label>
                    </div>
                </div>
            </div>
        </div>
        <div class="form-group trading-input">
            <input type="text" name="ammount" id="ammount" class="form-control" placeholder="IF YES' PLEASE INPUT TRADE NAME" <?php if(!empty($ammount)): echo 'value="'.$ammount.'"'; endif; ?>>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="business_desc" class="form-control"><?php if(!empty($business_desc)): echo $business_desc; endif; ?></textarea>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="share_value" name="share_value" placeholder="Share Value" <?php if(!empty($share_value)): echo 'value="'.$share_value.'"'; endif; ?>/>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-12">
            <input id="sumbit" class="btn-hover btn-save btn btn-outline btn-lg" type="submit" name="post_submit" value="Update" />
        </div>
    </div>
